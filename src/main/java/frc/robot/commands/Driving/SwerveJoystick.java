...
public class SwerveJoystick extends Command {
    ...
    public void execute() {
        if (DriverStation.isTeleop() && (!mSwerveSubsystem.getFindingPos())) {
            ...
            // Get Joystick inputs
            double ySpeed = mController.getRawAxis(Constants.Controllers.DrivingController.LeftYPort);
            double xSpeed = mController.getRawAxis(Constants.Controllers.DrivingController.LeftXPort);
